 ...
 * @author jlgallego99
 */
public class SCACV_Applet extends JApplet {
    ...
    private void createGUI() {
        ...
        Thread hebra1 = new Thread(panel);
        add(panel);
        Salpicadero salpicadero = new Salpicadero();
        salpicadero.setControlador(controlador);
        Thread hebra2 = new Thread(salpicadero);
        add(salpicadero);
        setSize(1000, 1000);
        hebra1.start();
        hebra2.start();
    ...
    /**
     * Initializes the applet SCACV_Applet
     */
    @Override
    public void init() {
    ...
    public static void main(String args[]) {
        // Crea e inicia el applet
        JApplet applet = new SCACV_Applet();
        applet.init();
